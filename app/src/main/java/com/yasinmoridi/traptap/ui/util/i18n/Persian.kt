...
val PersianStrings = AppStrings(
    ...
    simpleHints = mapOf(
        ...
        13 to "ظاهر می‌تونه فریبنده باشه.",
        14 to "واقع‌بینانه فکر کن."
    ),
    detailedHints = mapOf(
        ...
        13 to "حیوانی رو لمس کن که توی تصویر بزرگ‌تره، حتی اگه در واقعیت کوچیک‌تر باشه.",
        14 to "حیوانی رو لمس کن که در واقعیت بزرگ‌تره، بدون توجه به اندازه‌اش توی تصویر."
    ),
